...
To implement:
   ...
   - add instruction of how to play the game
   - have a player and score history
   - snake position and berry position to be implemented through the position/location class
